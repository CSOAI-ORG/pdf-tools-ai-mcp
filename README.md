<!-- mcp-name: io.github.CSOAI-ORG/pdf-tools-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/pdf-tools-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/pdf_tools_ai_mcp/)
...
```bash
# Install via pip
pip install pdf_tools_ai_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install pdf-tools-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/pdf-tools-ai-mcp)
...
```json
{
  "mcpServers": {
    "pdf-tools-ai-mcp": {
      "command": "uvx",
      "args": ["pdf-tools-ai-mcp"]
    }
  }
}
```

Or: `pip install pdf-tools-ai-mcp` then run the `pdf-tools-ai-mcp` command (stdio transport).
